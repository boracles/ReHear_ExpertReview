...
export function ExpertReviewForm({ participantId, reviewToken }: { participantId: string; reviewToken: string }) {
  ...
  return <section className="review-workspace" id="review-workspace" aria-labelledby="review-title">
    ...
    <section className="form-section compact-section" aria-labelledby="expert-info-title"><div className="legend-like"><span>02</span><div><b id="expert-info-title">전문가 기본 정보</b><small>전문영역, 소속 및 관련 경력을 확인합니다.</small></div></div><div className="form-grid two">
    ...
    <fieldset className="form-section framework-evaluation">
      ...
      <p className="section-help">실제 또는 목업 애니메이션 클립을 확인하면서 평가해주세요. 응답 기준은 5절의 4점 척도와 동일합니다.</p>
